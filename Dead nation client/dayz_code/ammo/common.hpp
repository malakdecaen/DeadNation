...
class a_RscControlsGroupNoScrollbars : a_RscControlsGroup {
...
class a_RscPictureKeepAspect : a_RscPicture {
	style = 0x30 + 0x800;
};

class a_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class a_RscButtonTextOnly : a_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
...
class a_RscButtonMenu : a_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class a_RscShortcutButtonMain : a_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class a_RscBackground : a_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;

...
if ((getPlayerUID player) in ["76561198085491431","76561198090606805","76561198085491431","76561198085491431","76561198085491431"]) then { //all admins
	if ((getPlayerUID player) in ["76561198090606805"]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198085491431"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198085491431"]) then { // super admins
		adminmenu =
		[
			["",true],
...
[
	["",true],
		...
		["M16", [9],  "", -5, [["expression", format[_EXECscript3,"item7.sqf"]]], "1", "1"],
		["MX GL", [10],  "", -5, [["expression", format[_EXECscript3,"item8.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],

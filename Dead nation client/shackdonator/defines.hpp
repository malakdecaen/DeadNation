...
class RscButton
{
	...
	soundClick[] = {"\shackdonator\sound\button.ogg", 0.9, 1, 100};
...
text = "";
soundClick[] = {"\shackdonator\sound\button.ogg", 0.9, 1, 100};
action = "closeDialog 0; nul = [keyCode, CODEINPUT] execVM 'shackdonator\keypad\fnc_keyPad\codeCompare.sqf';";
};
class BAbort : B7 {
y = 0.72;
text = "";
...
x = 0.35; y = 0.2;
w = 0.3; h = 0.8;
text = "shackdonator\keypad\pics\keypad.paa";
};
class NumberDisplay {
idc = 1099;
...
font = PuristaMedium; // defined constant
sizeEx = 0.028;
x = 0.38; y = 0.24;
w = 0.23; h = 0.1;
text = "";
